...
export default function RegisterVideo() {
    const formCadastro = useForm({
        initialValues: { titulo: "Titulo do video", url: "url do video", thumb: "url da Thumbnail", playlist: '3' }
    });
                    ...
                    <form onSubmit={(e) => {
                        ...
                        <div>
                            ...
                            <div className="vidpreview">
                                <a>
                                    <img src={
                                        checkurl(formCadastro.values.url) ?
                                            formCadastro.values.url.indexOf('youtube') > 0 ?
